...
$string['originality_waitingprocessmsg'] = "In transit";
...
$string['originality_no_upgrade'] = "Plugin is up to date";
...
$string['originality_live_server'] = "Live";

$string['originality_test_server'] = "Test";

$string['originality_customerservice_email'] = "customerservice@originality.co.il";

$string['originality_upgrade_error']= "There was an error with the upgrade.";

$string['originality_server_production'] = "<b>Production Server</b>&nbsp;&nbsp;<span style='font-size:14px;'>Send your submissions to Originality’s PRODUCTION server.</span>";

$string['originality_server_test'] = "<b>Test Server</b>&nbsp;&nbsp;<span style='font-size:14px;'>Send your submissions to Originality’s TEST server. You must coordinate with Originality before you choose it.</span>";